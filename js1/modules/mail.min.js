...
contentType:!1,processData:!1,url:$(this).attr("action"),success:function(a){a.status?window.location.href=a.page:alert(a.message)},error:function(a,f,e){alert(e)}})})}$("form[name=mail]").each(function(){init_mail($(this))});