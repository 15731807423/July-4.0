        ...
        <div id="install_steps" v-show="isMounted" style="display: none">
            <div class="jc-install-step" v-if="currentStep===0">
                ...
                <div class="jc-install-step-footer">
                    <button type="button" class="md-button md-raised md-primary md-theme-default" :disabled="!environmentsOk" @click.stop="stepToSettings">
                        <div class="md-ripple">
            ...
            <div class="jc-install-step" v-if="currentStep===1">
                <div class="jc-install-step-content">
                    <el-form ref="settings_form" :model="settings" :rules="rules" label-width="120px">
                        <el-form-item label="网址" prop="app_url">
                            <el-input size="medium" native-size="50" v-model="settings.app_url" placeholder="https://www.example.com">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="管理账号" prop="admin_name">
                            <el-input size="medium" native-size="50" v-model="settings.admin_name" placeholder="admin"></el-input>
                        </el-form-item>
                        <el-form-item label="管理密码" prop="admin_password">
                            <div class="jc-form-item-group">
                                <el-input size="medium" native-size="50" v-model="settings.admin_password">
                                </el-input>
                                <button type="button" class="md-button md-raised md-dense md-primary md-theme-default" @click.stop="randomPassword">
                                    <div class="md-ripple">
                        ...
                        <el-form-item label="邮箱" prop="mail_to_address" class="has-helptext">
                            <el-input size="medium" native-size="50" v-model="settings.mail_to_address" placeholder="someone@example.com">
                            </el-input>
                ...
                <div class="jc-install-step-footer">
                    <button type="button" class="md-button md-raised md-primary md-theme-default" @click.stop="install">
                        <div class="md-ripple">
            ...
            <div class="jc-install-step" v-if="currentStep===2">
                ...
                <div class="jc-install-step-footer">
                    <button type="button" class="md-button md-raised md-primary md-theme-default" :disabled="lastStepStatus!=='finish'" @click.stop="login">
                        <div class="md-ripple">
