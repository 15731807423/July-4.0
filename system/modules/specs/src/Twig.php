...
class Twig
{
    private static $resetButton = '<el-button :class="resetInside.class" :size="resetInside.size" :type="resetInside.type" :plain="resetInside.plain" :round="resetInside.round" :circle="resetInside.circle" :loading="resetInside.loading" :loading-icon="resetInside.loadingIcon" :disabled="resetInside.disabled" :icon="resetInside.icon" :autofocus="resetInside.autofocus" :native-type="resetInside.nativeType" :auto-insert-space="resetInside.autoInsertSpace" @click="screenClear(), keywords = \'\'">{{ resetInside.text }}</el-button>';
    ...
    public static function js($specs, $data = null, array $config = [])
    {
