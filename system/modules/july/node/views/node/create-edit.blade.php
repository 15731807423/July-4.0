...
<el-form id="main_form" ref="main_form" :model="model" :rules="rules" label-position="top">
    <div id="main_form_left">
        ...
        {{-- 视图文件 --}}
        <el-form-item prop="view" size="small" class="has-helptext" :rules="[{pattern:/^(?:[a-z0-9\-_]+\/)*[a-z0-9\-_]+\.(?:twig|html?)$/, message:'格式不正确', trigger:'change'}]">
