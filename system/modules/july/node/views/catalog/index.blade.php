...
<div id="main_tools">
    <div class="jc-btn-group">
        <a href="{{ short_url('catalogs.create') }}" title="编辑" class="md-button md-dense md-raised md-primary md-theme-default">
            <div class="md-ripple">
                <div class="md-button-content">新建目录</div>
            </div>
        </a>
    </div>
</div>
                ...
                <template slot-scope="scope">
                    <div class="jc-operators">
                        ...
                        <a :href="getUrl('tree', scope.row.id)" title="重排内容" class="md-button md-fab md-dense md-primary md-theme-default">
                            <div class="md-ripple">
                                <div class="md-button-content"><i class="md-icon md-icon-font md-theme-default">sort</i></div>
                            </div>
                        </a>
                        <button type="button" title="删除" class="md-button md-fab md-dense md-accent md-theme-default" @click="deleteCatalog(scope.row)" :disabled="scope.row.is_reserved">
                            <div class="md-ripple">
