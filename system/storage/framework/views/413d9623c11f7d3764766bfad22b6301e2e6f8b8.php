...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', '七月 CMS'); ?></title>
  ...
  <?php echo $__env->yieldContent('inline-style'); ?>
</head>
<body>
  ...
  <div id="layout_left">
    <div class="md-scrollbar md-theme-default" id="app_sidebar">
      <div id="app_brand">
        <a href="<?php echo e(short_url('admin.home')); ?>">
          <svg class="jc-logo md-icon"><use xlink:href="#jcon_logo"></use></svg>
          <span>七月 cms</span>
        </a>
      </div>
      <ul class="md-list md-theme-default">
        <?php $__currentLoopData = config('app.main_menu'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($item['route']): ?>
        <li class="md-list-item<?php echo e(under_route($item['route'], Request::getPathInfo())?' is-active':''); ?>">
          <a href="<?php echo e(short_url($item['route'])); ?>" class="md-list-item-link md-list-item-container md-button-clean">
            <div class="md-list-item-content">
              <i class="md-icon md-icon-font md-theme-default"><?php echo e($item['icon']); ?></i>
              <span class="md-list-item-text"><?php echo e($item['title']); ?></span>
            </div>
          </a>
        </li>
        <?php else: ?>
          ...
          <div class="md-list-item-expand md-list-item-container md-button-clean">
            ...
            <div class="md-list-expand">
              <ul class="md-list md-theme-default">
                ...
                <li class="md-list-item md-inset<?php echo e(under_route($child['route'], Request::getPathInfo())?' is-active':''); ?>">
                  <a href="<?php echo e(short_url($child['route'])); ?>" class="md-list-item-link md-list-item-container md-button-clean">
                    <div class="md-list-item-content"><?php echo e($child['title']); ?></div>
                  </a>
                </li>
  ...
  <div id="layout_right">
    ...
    <nav id="app_navbar">
      ...
      <div id="navbar_left">
        ...
        <?php $__currentLoopData = config('app.actions'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button type="button" class="md-button md-small md-primary md-theme-default"
          @click.stop="doAction('<?php echo e(short_url($action::getRouteName())); ?>', '<?php echo e($action::getTitle()); ?>')">
          <div class="md-ripple">
            <div class="md-button-content"><?php echo e($action::getTitle()); ?></div>
          </div>
        </button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div id="navbar_right">
        <!-- 搜索栏框 -->
        <form action="<?php echo e(short_url('action.search')); ?>" method="GET" id="navbar_search">
        ...
        <!-- 打开后台首页 -->
        <a href="<?php echo e(short_url('admin.home')); ?>" class="md-button md-icon-button md-theme-default" title="后台首页">
          <div class="md-ripple">
          ...
          <div class="md-menu-content-medium md-menu-content md-theme-default" v-show="adminMenuVisible">
            <div class="md-menu-content-container md-theme-default">
              <ul class="md-list md-theme-default">
                ...
                <li class="md-list-item md-menu-item md-theme-default">
                  <a href="<?php echo e(short_url('admin.logout')); ?>" class="md-list-item-link md-list-item-container md-button-clean">
    ...
    <div id="app_main" class="jc-scroll-wrapper">
      <div class="jc-scroll md-scrollbar md-theme-default">
        <div id="main_header">
          <h1><?php echo $__env->yieldContent('h1', '七月后台'); ?></h1>
    ...
    const navbar = new Vue({
      ...
      methods: {
        ...
        changePwd() {
          ...
          form.validate().then(() => {
            axios.post("<?php echo e(short_url('action.change_password')); ?>", clone(this.pwd.data)).then(response => {
              loading.close();
...
<?php /**PATH D:\laragon\www\test\system\resources\views/layout.blade.php ENDPATH**/ ?>