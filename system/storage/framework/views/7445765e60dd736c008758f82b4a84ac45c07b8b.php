      ...
      <div class="jc-install-step" v-if="currentStep===0">
        <div class="jc-install-step-content">
          <ul class="jc-env-list">
            <?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement => $ok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="jc-env<?php echo e($ok ? ' is-ok' : ''); ?>">
  ...
  <script>
    const app = new Vue({
      ...
      methods: {
        ...
        login() {
          location.href = "<?php echo e(short_url('admin.login')); ?>";
        },
      },
    });
  </script>
...
<?php /**PATH D:\laragon\www\test\system\modules\installer/views/install.blade.php ENDPATH**/ ?>