<?php $__env->startSection('h1', $title); ?>

<?php $__env->startSection('main_content'); ?>
<el-form id="main_form" ref="main_form" :model="settings" label-position="top">
    <div id="main_form_left">
        <el-form-item prop="lang.multiple" size="small" class="<?php echo e($items['lang.multiple']['description']?'has-helptext':''); ?>">
            <el-tooltip slot="label" popper-class="jc-twig-output" effect="dark" content="<?php echo $items['lang.multiple']['tips']; ?>" placement="right">
                <span><?php echo e($items['lang.multiple']['label']); ?></span>
            </el-tooltip>
            <el-switch v-model="settings['lang.multiple']" active-text="启用" inactive-text="不启用">
            </el-switch>
            <?php if($items['lang.multiple']['description']): ?>
            <span class="jc-form-item-help"><i class="el-icon-info"></i> <?php echo e($items['lang.multiple']['description']); ?></span>
            <?php endif; ?>
        </el-form-item>
        <div class="el-form-item el-form-item--small jc-embeded-field <?php echo e($items['lang.available']['description']?'has-helptext':''); ?>" v-if="settings['lang.multiple']">
            <div class="el-form-item__content">
                <div class="jc-embeded-field__header">
                    <el-tooltip popper-class="jc-twig-output" effect="dark" content="<?php echo $items['lang.available']['tips']; ?>" placement="right">
                        <label class="el-form-item__label"><?php echo e($items['lang.available']['label']); ?></label>
                    </el-tooltip>
                        ...
                        <tbody>
                            <tr v-for="(info, langcode) in settings['lang.available']" :key="langcode">
                                ...
                                <td>
                                    ...
                                    ref="upload"
                                    name="files"
                                    action="<?php echo e(short_url('media.upload')); ?>"
                                    :limit="1"
                ...
                <?php if($items['lang.available']['description']): ?>
                <span class="jc-form-item-help"><i class="el-icon-info"></i> <?php echo e($items['lang.available']['description']); ?></span>
                <?php endif; ?>
            </div>
        </div>
        <el-form-item size="small" class="<?php echo e($items['lang.content']['description']?'has-helptext':''); ?>" v-if="settings['lang.multiple']">
            <el-tooltip slot="label" popper-class="jc-twig-output" effect="dark" content="<?php echo $items['lang.content']['tips']; ?>" placement="right">
                <span><?php echo e($items['lang.content']['label']); ?></span>
            </el-tooltip>
            ...
            <?php if($items['lang.content']['description']): ?>
            <span class="jc-form-item-help"><i class="el-icon-info"></i> <?php echo e($items['lang.content']['description']); ?></span>
            <?php endif; ?>
        </el-form-item>
        <el-form-item size="small" class="<?php echo e($items['lang.frontend']['description']?'has-helptext':''); ?>" v-if="settings['lang.multiple']">
            <el-tooltip slot="label" popper-class="jc-twig-output" effect="dark" content="<?php echo $items['lang.frontend']['tips']; ?>" placement="right">
                <span><?php echo e($items['lang.frontend']['label']); ?></span>
            </el-tooltip>
            ...
            <?php if($items['lang.frontend']['description']): ?>
            <span class="jc-form-item-help"><i class="el-icon-info"></i> <?php echo e($items['lang.frontend']['description']); ?></span>
            <?php endif; ?>
        </el-form-item>
...
const app = new Vue({
    ...
    data() {
        return {
            settings: <?php echo json_encode($settings, JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE, 512) ?>,
            selected: null,
            langnames: <?php echo json_encode(lang()->getLangnames(), JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE, 512) ?>,
            langcode: '',
            fileList: [],
            uploadCode: '',
            data: {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$refs.main_form.validate().then(() => {
                axios.post("<?php echo e(short_url('settings.update', $name)); ?>", this.settings).then(response => {
                    loading.close();
                    this.original_settings = _.cloneDeep(this.settings);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\test\system\resources\views/settings/language.blade.php ENDPATH**/ ?>