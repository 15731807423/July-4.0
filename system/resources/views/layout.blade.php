...
<body>
    ...
    <div id="layout_right">
        ...
        <nav id="app_navbar">
            ...
            <div id="navbar_left">
                <!-- 展开 / 折叠左侧菜单 -->
                <button type="button" title="折叠/展开" class="md-button md-icon-button md-theme-default" @click.stop="toggleSidebar">
                    <div class="md-ripple">
                ...
                <button type="button" class="md-button md-small md-primary md-theme-default" @click.stop="clearCache">
                    <div class="md-ripple">
                        <div class="md-button-content">清除缓存</div>
                    </div>
                </button>
                <button type="button" class="md-button md-small md-primary md-theme-default" @click.stop="buildGoogleSitemap">
                    <div class="md-ripple">
            ...
            <div id="navbar_right">
                ...
                <div class="md-menu jc-dropdown">
                    <button type="button" class="jc-primary md-button md-icon-button md-primary md-theme-default" @click.stop="toggleAdminMenu">
                        <div class="md-ripple">
                        ...
                        <div class="md-menu-content-container md-theme-default">
                            <ul class="md-list md-theme-default">
                                <li class="md-list-item md-menu-item md-theme-default">
                                    <a href="#" class="md-list-item-link md-list-item-container md-button-clean" @click.prevent="pwd.dialogVisible = true">
            ...
            <el-dialog id="change_pwd" ref="change_pwd" title="修改密码" top="-5vh" :close-on-click-modal="false" :append-to-body="true" :visible.sync="pwd.dialogVisible">
                ...
                <span slot="footer" class="dialog-footer">
                    <button type="button" class="md-button md-raised md-dense md-theme-default" @click.stop="pwd.dialogVisible = false">
                        <div class="md-ripple">
                            <div class="md-button-content">取 消</div>
                        </div>
                    </button>
                    <button type="button" class="md-button md-raised md-dense md-primary md-theme-default" @click.stop="changePwd">
                        <div class="md-ripple">
